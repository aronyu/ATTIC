...
function condCVAE.create(opts)
  local encoder = condCVAE.create_encoder(opts)
  local decoder = condCVAE.create_decoder(opts)
  return encoder, decoder
end

function condCVAE.create_encoder(opts)
...
function condCVAE.create_decoder(opts)
