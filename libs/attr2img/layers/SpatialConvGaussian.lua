...
local SpatialConvGaussian, parent = torch.class('nn.SpatialConvGaussian', 'nn.Module')

function SpatialConvGaussian:__init(nInputPlane, nOutputPlane, kW, kH, dW, dH, padW, padH)
  parent.__init(self)
  self.mean_layer = nn.SpatialConvWP(nInputPlane, nOutputPlane, kW, kH, dW, dH, padW, padH)
  self.sigma_layer = nn.SpatialConvWP(nInputPlane, nOutputPlane, kW, kH, dW, dH, padW, padH)
